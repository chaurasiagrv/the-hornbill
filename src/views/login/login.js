...
import Google from "../../Data Base/google.png";
import './login.css';
            ...
            <div className='Login_card'>
                <div className='Login_card_container_main'>
                    <div className='Login_card_container'>
                        <div className='Login_background'>
                            <div>
                                <img src={HornBillIcon}
                                    className='hornbill_logo' alt='bird' />
                            </div>
                            <div className='main_title'>
                                <h2>The HornBill</h2></div>
                        </div>
                        <div className='Login_wlcm'>
                            Welcome Back
                        </div>
                        {isError &&
                        ...
                        <button
                            ...
                            style={{
                                backgroundColor:
                                    (!email.length || !password.length || isDisable) ? "grey" : "#866cff"
                            }}
                        >
                            {isDisable && <iframe
                                src="https://giphy.com/embed/L05HgB2h6qICDs5Sms"
                                width="40" height="40" frameBorder="0" class="giphy-embed" title='loader'></iframe>}
